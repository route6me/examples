...
Cline → MCP Servers → **Remote Servers** → add (or edit `cline_mcp_settings.json`):
...
*(Field names follow Cline's remote-server schema as of mid-2026 — verify against current Cline docs at publish time.)*
